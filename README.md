...
Phones, iPads, and laptops share the same logo, content, services, and enquiry flow. Columns and navigation adapt to the available screen width; the pickup link remains available in the compact navigation. The contact section stacks on tablets, and form fields stack on narrow phones. Form text uses 16px sizing for comfortable mobile entry.
